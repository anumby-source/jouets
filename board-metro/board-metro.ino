...
char getRequest[] = "/v4/schedules/metros/8/daumesnil/R";
...
//   display.begin(SSD1306_SWITCHCAPVCC);
 ...
 Serial.begin(115200);
    pinMode(GND, OUTPUT);      // board 
  digitalWrite(GND, LOW);
    pinMode(PLUS, OUTPUT);      // board 
 ...
 // display.flipScreenVertically();                                                               // Flip Screen upsidedown
  ...
  display.drawString(0, 6, "METRO");                                                   // Print String at 6, 6
  display.setFont(ArialMT_Plain_10);                                                            // Setting Font
  display.drawString(24, 34, "ANUMBY");                                             // Print String at 24, 34
  display.drawString(29, 44, "Arnaud");                                                  // Print String at 29, 44
